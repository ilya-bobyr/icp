...
/// that have several different forms.  The first parser, in order, that
/// succeeds is considered to be the result of the `AlternativesCommandParser`
/// parser.  In case no parser succeeds the combined parser error is the error
/// generated by the parser that managed to parse the most of the input.
///
